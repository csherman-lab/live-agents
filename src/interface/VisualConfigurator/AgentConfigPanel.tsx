...
export const AgentConfigPanel: React.FC<AgentConfigPanelProps> = ({
  ...
  return (
    <div className="w-80 h-full theme-panel border-l flex flex-col pointer-events-auto overflow-hidden animate-in slide-in-from-right-full duration-300" style={{ borderColor: 'var(--apple-border)' }}>
      {/* Header */}
      <div className="px-4 py-2.5 border-b theme-muted flex items-center justify-between" style={{ borderColor: 'var(--apple-border)' }}>
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-sm text-[var(--apple-text)] uppercase tracking-tight truncate">
          ...
          <>
              ...
              {renderField('Name', <CircleUser size={12} />, isView ? (
                ...
                <div className="space-y-1">
                  <input
                    ...
                    className={`w-full px-3 py-2 theme-input rounded-xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-black/5 ${nameCollision ? 'border-red-500 text-red-600' : ''
                      }`}
                  />
                  {nameCollision && (
            ...
            <div className="space-y-6">
              {renderField('Description', <Target size={12} />, isView ? (
                <div className="theme-muted p-4 rounded-xl border min-h-[120px]" style={{ borderColor: 'var(--apple-border)' }}>
                  <p className="text-xs text-[var(--apple-text-secondary)] leading-relaxed whitespace-pre-wrap font-medium italic">
                ...
                <textarea
                  ...
                  className="w-full h-48 px-3 py-2 theme-input rounded-xl text-xs leading-relaxed focus:outline-none focus:ring-2 focus:ring-black/5 resize-none font-medium text-[var(--apple-text-secondary)]"
      ...
      {/* Footer Actions */}
      {!isView && !isUser && (
        <div className="p-4 border-t theme-muted flex flex-col gap-2" style={{ borderColor: 'var(--apple-border)' }}>
          <button
            onClick={handleSave}
            disabled={!isValid}
