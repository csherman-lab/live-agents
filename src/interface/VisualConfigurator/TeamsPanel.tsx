...
export const TeamsPanel: React.FC<TeamsPanelProps> = ({ onSelectTeam, selectedTeamId, onModeChange, mode }) => {
  ...
  return (
    <div className="w-96 border-l theme-panel flex flex-col h-full shrink-0" style={{ borderColor: 'var(--apple-border)' }}>
      ...
      <div className="p-4 border-t theme-panel" style={{ borderColor: 'var(--apple-border)' }}>
        <button
          onClick={handleCreateNew}
          className="w-full flex items-center justify-center gap-2 py-3 bg-ink hover:bg-ink text-white rounded-xl text-[10px] font-black uppercase tracking-[0.1em] transition-all shadow-lg shadow-black/5 active:scale-[0.98]"
        >
