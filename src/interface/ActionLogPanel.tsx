...
`.trim();
    ...
    return (
        <div className="w-[min(300px,28vw)] h-full panel-sidebar border-r border-black/5 flex flex-col pointer-events-auto overflow-hidden shrink-0 relative">
            {/* Header */}
            <div className="h-12 px-4 border-b border-black/5 flex items-center justify-between shrink-0 gap-2">
                <div className="flex items-center gap-2 min-w-0">
                    <span className="text-[13px] font-semibold text-[var(--apple-text)] shrink-0">Activity Log</span>
                    {filterAgent && (
                        <div
                            className="flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-medium text-white truncate"
            ...
            {/* Tab Switcher */}
            <div className="flex border-b app-bar">
                <button
                    onClick={() => setActiveTab('activity')}
                    className={`flex-1 py-2.5 text-[11px] font-semibold transition-apple ${activeTab === 'activity' ? 'theme-panel border-b-2 border-appleBlue text-appleBlue' : 'text-zinc-400 hover:text-zinc-600'
                        }`}
                >
                    Activity
                </button>
                <button
                    ...
                    className={`flex-1 py-2.5 text-[11px] font-semibold transition-apple ${activeTab === 'technical' ? 'theme-panel border-b-2 border-appleBlue text-appleBlue' : 'text-zinc-400 hover:text-zinc-600'
                        }`}
                >
                    Technical
                </button>
