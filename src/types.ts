...
export interface CharacterState {
  ...
  pendingTeamSwitchId: string | null;
  skipProjectResetOnTeamChange: boolean;
  byokError: string | null;
  apiTestStatus: 'idle' | 'testing' | 'ok' | 'error';
  ...
  setPendingTeamSwitch: (teamId: string | null) => void;
  setSkipProjectResetOnTeamChange: (skip: boolean) => void;
  setApiTestStatus: (status: 'idle' | 'testing' | 'ok' | 'error', error?: string | null) => void;
  openApiSettings: (error?: string | null) => void;
